 ...
 *
 * @note To access detail of the latest @ref `BDZoneInfo` downloaded to the SDK, access `[BDLocationManager.instance zoneInfos]`
 */
 ...
 *
 * @param enterEvent Contains zone entry event information. Refer to `GeoTriggerEvent` for more information.
 */
 ...
 *
 * @param exitEvent Contains zone exit event information. Refer to `GeoTriggerEvent` for more information.
 */
