...
@property (nonatomic, readonly) PushNotifications *pushNotifications;
 ...
 * @param completion A mandatory completion handler called once Start GeoTriggering processing completed. If the GeoTriggering feature is started successfully, error will be returned as nil. However, if the Start GeoTriggering feature fails, an error will be provided.
*/
 ...
 * @param completion A mandatory completion handler called once Stop Geotriggering processing completed. If the Geotriggering feature is stopped successfully, error will be returned as nil. However, if the Stop Geotriggering fails, an error will be provided.
*/
 ...
 * @param completion A mandatory completion handler called once Start Tempo processing completed. If the Tempo is started successfully, error will be returned as nil. However, if the Start Tempo fails, an error will be provided.
*/
 ...
 * Stop Tempo Tracking
 *
 * @param completion A mandatory completion handler called once Stop Tempo processing completed. If the Tempo is stopped successfully, error will be returned as nil. However, if the Stop Tempo fails, an error will be provided.
*/
