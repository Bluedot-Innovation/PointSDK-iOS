...
/// @brief A Destination is a physical location your customers arrive at to collect their mobile order – this is usually your store or restaurant. Also known as Stores within Canvas
...
/// A @ref BDPoint that stores spatial geographic information (i.e longitude, latitude) of the destination
...
/// This event is being sent to application via <code>BDPGeoTriggeringEventDelegate.didEnterZone:</code>
/// and <code>BDPGeoTriggeringEventDelegate.didExitZone:</code>.
SWIFT_CLASS("_TtC10BDPointSDK15GeoTriggerEvent")
@interface GeoTriggerEvent : NSObject
/// The installation reference of this Point SDK enabled App. Same as <code>BDLocationManager.instance.installRef</code>
...
/// Notificaiton Type of this event. For GeoTriggerEvent events, can be either .entry or .exit
...
/// <ul>
///   <li>
///     An entry event will inlcude only 1 item of type <code>FenceEntered</code>.
///   </li>
///   <li>
...
/// Detail of the @ref TempoUpdate event being reported to main application via callback <code>tempoTrackingDidUpdate:</code>
