...
SWIFT_CLASS("_TtC10BDPointSDK9AppConfig")
@interface AppConfig : NSObject
+ (BOOL)isLiveUpdateEnabled SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC10BDPointSDK18DwellConfiguration")
@interface DwellConfiguration : NSObject
/// Whether dwell detection is active.
@property (nonatomic, readonly) BOOL enabled;
/// Threshold in seconds.
@property (nonatomic, readonly) NSInteger threshold;
- (nonnull instancetype)initWithEnabled:(BOOL)enabled threshold:(NSInteger)threshold OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@interface DwellConfiguration (SWIFT_EXTENSION(BDPointSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, readonly) NSUInteger hash;
@end
...
SWIFT_CLASS("_TtC10BDPointSDK19DwellEventScheduler")
@interface DwellEventScheduler : NSObject
@property (nonatomic, readonly, strong) id <Logger> _Nullable logger;
- (nonnull instancetype)initWithLogger:(id <Logger> _Nonnull)logger OBJC_DESIGNATED_INITIALIZER;
- (void)scheduleDwellTimerFor:(PendingDwell * _Nonnull)pendingDwell completion:(void (^ _Nonnull)(TriggerEventNotification * _Nonnull))completion;
- (void)stopMonitoringDwellEventFor:(NSString * _Nonnull)triggerChainId;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly) NSTimeInterval calculatedDwellTime;
/// Dwell time threshold configured in backend, in milliseconds
@property (nonatomic, readonly) NSTimeInterval dwellThreshold;
/// :nodoc:
- (nonnull instancetype)initWithFenceId:(NSUUID * _Nonnull)fenceId fenceName:(NSString * _Nonnull)fenceName eventTime:(NSDate * _Nonnull)eventTime locations:(NSArray<CLLocation *> * _Nonnull)locations calculatedDwellTime:(NSTimeInterval)calculatedDwellTime dwellThreshold:(NSTimeInterval)dwellThreshold appState:(AppState * _Nonnull)appState;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// A GeoTrigger event, e.g. <code>FenceEntered</code>or <code>FenceExited</code> or <code>FenceDwell</code>.
...
@interface FenceDwell (SWIFT_EXTENSION(BDPointSDK)) <TriggerEvent>
@end

@interface FenceDwell (SWIFT_EXTENSION(BDPointSDK)) <JsonString>
/// Convert to JSON string
/// This function throws an error if JSON encoding process fails
- (NSString * _Nullable)toJson:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end

@interface FenceDwell (SWIFT_EXTENSION(BDPointSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end

@interface FenceDwell (SWIFT_EXTENSION(BDPointSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end
...
/// For dwell trigger event, this returns the <code>FenceEntered</code> event linked to the <code>FenceDwell</code> in the same <code>triggerChainId</code>
...
/// <code>nil</code> if this GeoTriggerEvent is an entry event or a dwell event.
@property (nonatomic, readonly, strong) FenceExited * _Nullable exitEvent;
/// A <code>FenceDwell</code> event causing the zone dwell trigger, same as the first event in <code>triggerEvents</code>.
/// <code>nil</code> if this GeoTriggerEvent is Entry or Exit event without dwell condition met.
@property (nonatomic, readonly, strong) FenceDwell * _Nullable dwellEvent;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (void)setBackgroundActivityWithValue:(BOOL)value SWIFT_AVAILABILITY(ios,introduced=17.0);
- (BOOL)isUpdatesStarted SWIFT_WARN_UNUSED_RESULT;
- (NSArray<CLLocation *> * _Nonnull)onLocationUpdates:(NSArray<CLLocation *> * _Nonnull)locations SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@interface LocationSensor (SWIFT_EXTENSION(BDPointSDK))
- (void)startLocationUpdates SWIFT_AVAILABILITY(ios,introduced=17.0);
...
/// GeoTrigger dwell when device dwells in a zone
  NotificationTypeDwell = 2,
/// Tempo event
  NotificationTypeTempo = 3,
/// SDK Lifecycle event
  NotificationTypeLifecycle = 4,
/// Other unknown cases
...
@class PendingEvent;
SWIFT_CLASS("_TtC10BDPointSDK12PendingDwell")
@interface PendingDwell : NSObject
- (nonnull instancetype)initWithEvent:(PendingEvent * _Nonnull)event threshold:(NSTimeInterval)threshold OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) BOOL defaultLiveUpdateEnabled;)
+ (BOOL)defaultLiveUpdateEnabled SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, readonly) BOOL liveUpdateEnabled;
...
/// Trigger Engine of the PointSDK when this trigger happens.
/// @see <a href="https://docs.bluedot.io/Point%20SDK/iOS/Features/Enhanced%20SDK%20restart">our documentation</a> for more details.
...
@property (nonatomic, readonly, copy) NSString * _Nonnull projectId;
@property (nonatomic, readonly, strong) DeviceInfo * _Nonnull deviceInfo;
@property (nonatomic, copy) NSDate * _Nonnull submissionTime;
@property (nonatomic, copy) NSUUID * _Nonnull triggerChainId;
@property (nonatomic) enum NotificationType notificationType;
@property (nonatomic, strong) ZoneInfo * _Nonnull zoneInfo;
@property (nonatomic, strong) AppInfo * _Nonnull appInfo;
@property (nonatomic, copy) NSArray<id <TriggerEvent>> * _Nonnull triggerEvents;
@property (nonatomic) int16_t retryCount;
...
- (NSURLRequest * _Nullable)request:(NSURL * _Nonnull)endpoint error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
